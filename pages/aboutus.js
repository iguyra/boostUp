...
import IconImage from "../Components/Modules/IconImage";
      ...
      <div className="login">
        <div className="terms__container">
          <div className="save__gradient">
            <div className="terms__heading">ABOUT US</div>

            <IconImage imgSrc="/static/learn.jpg" />
            <div className="terms__paragraph">
              These terms & conditions (the “T&C” or “Terms”) govern your access
              and use of our Website and services at SmartWritingService.com
            ...
            <div className="terms__paragraph">
              ...
              legal authority to enter these Terms of Use and to be legally
              bound by it.
            </div>
            ...
            <div className="terms__paragraph">
              ...
              immediately upon discovery you are accessing the Website or
              Services in violation of these restrictions.
            </div>
