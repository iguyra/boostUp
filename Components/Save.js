          ...
          <div className="save__list">
            ...
            >
              ...
              <div className="save__bottom">
                <div className="save__itemHeading">Need help ? No problem</div>
                <div className="save__itemWords">
                  with ever ready team of expects, be assured of quality support
            ...
            <div data-aos="fade-up" className="save__item">
              ...
              <div className="save__bottom">
                ...
                <div className="save__itemWords">
                  meet people who are doing the same thing you are doing, which
                  open doors for more jobs
                </div>
              </div>
            </div>
            ...
            <div data-aos="fade-down" className="save__item">
              ...
              <div className="save__bottom">
                ...
                <div className="save__itemWords">
                  With expects who have spend years gathering resouces and all
                  these resouces at your disposal
                </div>
              </div>
            </div>
          </div>
